...
from jubin.site.content.base import BasePartner
...
class PartnersView(BrowserView):
    """
    AddressOrganizations browser view
    """
    implements(IPartnersView)

    pt = ViewPageTemplateFile('templates/partnersview.pt')
    ...
    def get_organizations(self):
        ...
        This method returns all organizations inside this address book
        """
        brains = self.portal_catalog({'portal_type':['JubinStationPartner', 
